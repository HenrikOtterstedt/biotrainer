...
# the light attention architecture but with a regression output instead of a class output
class LightAttentionRegression(nn.Module):
    def __init__(self, n_features: int, n_classes: int, dropout_rate=0.25, kernel_size=9, conv_dropout: float = 0.25,
                 **kwargs
                 ):
        super(LightAttentionRegression, self).__init__()
